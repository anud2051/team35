...
testSchool9 = TestCase $ assertEqual "all possible moves for queen from (3,3) at school mate board" [(3,4),(3,5),(3,6),(3,7),(3,8),(4,4),(5,5),(6,6),(7,7),(8,8),(4,3),(5,3),(6,3),(7,3),(8,3),(4,2),(5,1),(3,2),(3,1),(2,2),(1,1),(2,3),(1,3),(2,4),(1,5)] (possibleMoves (Piece Queen (3,3) White))
...
validMoveKing = TestCase $ assertEqual "king move to check position" False (isValidMove staleMateTestBoard2 (Piece King (1,1) White) (2,1))
runtest = runTestTT $ TestList [test1,test2,test3,test4,test5,testCheckMate, testStaleMateTrue,testStaleMateFalse,validMoveKing]

schooltest = runTestTT $ TestList [testSchool1,testSchool2,testSchool3,testSchool4,testSchool5,testSchool6,testSchool7,testSchool8,testSchool9]
