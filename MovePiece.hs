...
{-movePiece square move board 
  moves a pieces from one square to another square in the board¨
  PRE: square == (Piece ptype position color)
  RETURNS: an updated board where the position of the given square has been empty and the square at the position of the given move has been updated containing the piece of given square
  EXAMPLES: 
            movePiece (Piece Rock (1,1) White) (1,2) [Piece Rock (1,1) White, Piece Knight (1,2) White, Piece Bishop (1,3) White, Piece Queen (1,4) White] == [Empty (1,1),Piece Rock (1,2) White,Piece Bishop (1,3) White,Piece Queen (1,4) White]
...
{- replaceWithEmpty square board
  replaces the square a piece has left with an empty square
  RETURNS: a Board where the position of square in board is replaced with Empty
...
{- posToSquare pos board
  finds the piece on a specific position
  PRE: pos1 has to exist in board
  RETURNS: the Square of the position pos in board
...
{-replace piece1 piece2 xs
  ...
  EXAMPLES: removePiece (Piece Queen (8,5) Black) (Piece Rock (1,1) White) [Piece Rock (1,1) White,Piece Knight (1,2) White,Piece Bishop (1,3) White] == 
[Piece Queen (1,1) Black,Piece Knight (1,2) White,Piece Bishop (1,3) White]
-}
